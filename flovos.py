...
class FlowProcessor(nn.Module):
    def __init__(self):
        ...
        self.conv = nn.Conv2d(2, 1024, kernel_size=3, stride=16, padding=1)
...
class SpatialAttention(nn.Module):
    def __init__(self):
        ...
        self.conv2 = nn.Conv2d(64, 1, kernel_size=7, padding=3)  # Reduce to one channel
    ...
    def forward(self, feature, flow):
        # flow: 1, 2, 384, 384
        # r4: 1, 512, 24, 24
        self.avg_pool_flow = nn.AdaptiveAvgPool2d((feature.shape[2],feature.shape[3]))
        ...
        return feature * expanded_attention_map
